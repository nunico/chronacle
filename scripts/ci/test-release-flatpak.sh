...
require_fixed "$test_root/state/calls" '/app/bin/../lib/Chronacle/resources/pdfium/libpdfium.so'
require_fixed "$test_root/state/calls" '/app/bin/../lib/Chronacle/resources/onnxruntime/libonnxruntime.so'
