...
- Bei einem Online-Antwortanbieter sendet Chronacle die Frage und den bereitgestellten Antwortkontext an diesen Anbieter. Abhängig von der gewählten Kampagne und den Quellen kann das relevante Quellenauszüge; Namen von Entitäten, Zusammenfassungen, Notizen und kompilierte Codex-Artikel; Spielernamen sowie Klasse, Stufe und Status; Start- und Enddaten von Ereignissen; Sitzungsnummern, -titel, Spieldaten und -notizen; sowie kompilierte Regeln umfassen. Kampagnenentitäten und Sitzungen können dabei als vollständiger kampagnenbezogener Kontext statt als relevanzgefilterte Ergebnisse enthalten sein.
