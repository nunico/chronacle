...
1. Open **Settings** and find **LLM provider**. An LLM provider is the service or local program that turns your question and source excerpts into a reply.
...
- When an online answer provider is active, Chronacle sends it the question and relevant retrieved excerpts to produce the reply.
